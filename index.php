...
<?php include("php/mysqli_connect.php"); ?>
...
<head>
	...
	*/
	...
	function select_pegawai(id_textbox, tulisan_yang_diparsing){
        $("#" + id_textbox).val(tulisan_yang_diparsing);
        $("#list_pegawai_usulan_pmk").dialog("close");
    }
    </script>
</head>
...
<div id="menubar">
	...
	if(isset($_SESSION["simpeg_id_level"])){
        switch($_SESSION["simpeg_id_level"]){
            case 1 :
                if($_SESSION["simpeg_id_tipe_jabatan"] == 1)
            ...
            case 7 :
                ...
                break;
            case 9 :
                include "isi/menubar/modul_9.php";
                break;
            case 12 :
...
<?php
    if(empty($_SESSION["simpeg_id_pengguna"])){
	   ...
	   if(isset($_GET["mod"])){
			...
			// LAPORAN LAPORAN
			case "laporan_sk_kenpang" :
				include "isi/panel/laporan/laporan_sk_kenpang.php";
				break;
			case "laporan_ijazah_upload" :
				include "isi/panel/laporan/laporan_ijazah_upload.php";
				break;	
			...
			case "cp_manage_jabatan" :
				...
				break;
			case "cp_manage_tk_pendidikan" :
				include "isi/panel/c_panel/cp_manage_tk_pendidikan.php";
				break;
			case "daftar_usulan" :
				include "isi/panel/usulan_list.php";
				break;
			case "daftar_usulan_kenpang" :
				include "isi/panel/usulan_list_kenpang.php";
				break;
			case "daftar_usulan_kesdip" :
				include "isi/panel/usulan_list_kesdip.php";
				break;		
        }
	  }	
    }
