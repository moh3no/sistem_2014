...
<script type="text/javascript">
	function terkirim(){
		document.location.href = "?mod=ucapan_kenpang_terkirim";
	}

</script>
<form name="frm_pesan" id="frm_pesan" action="php/ucapan/ucapan_kenpang.php" method="POST">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">KIRIM PESAN UCAPAN SELAMAT KENAIKAN PANGKAT</h3>
	<?php
		if(isset($_GET['code']) && isset($_GET['mode'])){
			if($_GET['code'] == '1' && $_GET['mode'] == 'add'){
				...
				print "Pesan Ucapan Kenaikan Pangkat Berhasil Dikirimkan.<br/></center>";
				print "</div><br/>";
