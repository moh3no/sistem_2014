...
?>
<form name="frm_edit_pesan" id="frm_edit_pesan" action="php/ucapan/ucapan_kenpang_edit.php" method="POST">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">EDIT PESAN UCAPAN SELAMAT KENAIKAN PANGKAT (ID DATA : <?=$row['id_pesan'];?>)</h3>
