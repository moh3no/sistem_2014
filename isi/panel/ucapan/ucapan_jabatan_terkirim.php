...
function edit(id_data){
    document.location.href='?mod=ucapan_jabatan_edit&id_pesan=' + id_data;
}
...
function hapus(id_data){
    jConfirm("Hapus data pesan dengan ID "+id_data+" ?", "PERHATIAN", function(r){
       if(r){
			...
			$.get("php/ucapan/ucapan_jabatan_hapus.php", {id_pesan : id_data},
						function(data){
							$('#notifikasi').show();
...
function kembali(){
	document.location.href = "?mod=ucapan_kenaikan_jabatan";
}
</script>
<div class="panelcontainer" style="width: 100%;">
    <h3 style="text-align: left;">DAFTAR PESAN TERKIRIM UCAPAN SELAMAT KENAIKAN JABATAN PEGAWAI</h3>
