...
<div class="panelcontainer" style="width: 100%;">
    ...
    <div class="bodypanel">
        ...
        <div class="kelang"></div>
        <?php
            $ds_bulan_ke = mysql_fetch_array(mysql_query("SELECT bulan FROM tbl_uraian_realisasi_skp WHERE id_skp='" . $_GET["id_skp"] . "' AND status_supervisi=1 GROUP BY bulan"));
            $bulan_ke = $ds_bulan_ke["bulan"];
        ?>
        <div style="padding: 5px; border: solid 1px #CCC; font-family: sans-serif; font-size: 10pt; font-weight: bold;">Bulan Ke : <?php echo( $bulan_ke . " ( " . bulan_ke_skp($bulan_ke, $_GET["id_skp"]) . " )"); ?></div>
        <div class="kelang"></div>
        ...
        <?php
            $res_data = mysql_query("SELECT
                                    ...
                                    WHERE
                                    	a.id_skp = '" . $_GET["id_skp"] . "' AND c.status_supervisi = 1");
            $no = 0;
