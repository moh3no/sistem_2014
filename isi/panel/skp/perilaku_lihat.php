...
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">ISI DATA KEBERATAN, TANGGAPAN, DAN KEPUTUSAN  PERILAKU PEGAWAI <?php echo(strtoupper(detail_pegawai($_SESSION["simpeg_id_pegawai"], "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($_SESSION["simpeg_id_pegawai"], "nip"))); ?>)</h3>
    <div class="bodypanel bodyfilter" id="bodyfilter">
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td>
        ...
        <?php
                ...
                echo("<div style='font-family: verdana; font-weight: light; color: #458B00; font-size: 9pt; padding: 3px 10px; background-color: #EEEEEE; margin-bottom: 10px;'>Data keberatan anda telah selesai di proses</div>");
            }
        ?>
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
