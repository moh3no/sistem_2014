...
<div class="panelcontainer" style="width: 100%;">
    ...
    <div class="bodypanel bodyfilter" id="bodyfilter">
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td width='50%'>
                    <input type="text" name="nama_pegawai" placeholder="Cari Nama Pegawai" title="Nama Pegawai" value="<?php 
					$nama_pegawai = (isset($_POST["nama_pegawai"]) ? $_POST["nama_pegawai"] : "");
					echo  $nama_pegawai;
					?>" />
                </td>
                <td>
                    <input type="text" name="nip" placeholder="Cari NIP Pegawai" title="NIP Pegawai" value="<?php 
...
<div class="panelcontainer" style="width: 100%;">
    ...
    <table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
        ...
        <tbody>
        <?php
            $whr = " AND a.nama_pegawai LIKE '%" . $nama_pegawai . "%' AND a.nip LIKE '%" . $nip . "%' ";
