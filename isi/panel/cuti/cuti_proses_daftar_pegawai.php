...
<?php
    ...
    $sql_list_pegawai = "SELECT
                        ...
                        FROM
                        	...
                        	LEFT JOIN tbl_usulan_cuti e ON (a.id_pegawai = e.id_pegawai AND e.no_usulan = '" . $_GET["no_usulan"] . "' AND e.diproses=0)
                        WHERE
...
function terima(id_usulan){
    document.location.href="?mod=cuti_proses&id_usulan=" + id_usulan + "&no_usulan=<?php echo($_GET["no_usulan"]); ?>";
}
