...
<form name="frm" id="frm" action="php/riwayat_jabatan/riwayat_jabatan_tambah.php" method="post">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">TAMBAH DATA RIWAYAT JABATAN <?php echo(strtoupper(detail_pegawai($_SESSION["simpeg_id_pegawai"], "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($_SESSION["simpeg_id_pegawai"], "nip"))); ?>)</h3>
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                ...
                <td>
                    ...
                    <input placeholder=":: Nomor SK. ::" type="text" name="no_sk_jabatan" id="no_sk_jabatan" />
                </td>
                <td width='300px'>
                    <label>Tgl SK Jabatan :</label>
                    <input placeholder=":: Tgl SK. ::" type="text" name="tgl_sk_jabatan" id="tgl_sk_jabatan" />
                </td>
            </tr>
        </table>
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td>
                    ...
                    <input placeholder=":: Nomor SK. Pelantikan ::" type="text" name="no_sk_pelantikan" id="no_sk_pelantikan" />
                </td>
                <td width='300px'>
                    <label>Tgl SK Pelantikan :</label>
                    <input placeholder=":: Tgl SK. Pelantikan ::" type="text" name="tgl_sk_pelantikan" id="tgl_sk_pelantikan" />
                </td>
                <td width='300px'>
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td>
                    ...
                    <input placeholder=":: Pejabat Pelantik ::" type="text" name="pejabat_pelantik" id="pejabat_pelantik" />
                </td>
            </tr>
        </table>
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
