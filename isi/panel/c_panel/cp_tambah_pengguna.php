...
<script>
	...
	function kembali(){
		document.location.href = "?mod=c_panel";
	}
</script>
<center>
<div class="panelcontainer panelform" style="width: 90%;">
    <h3 style="text-align: left;">TAMBAH DATA PENGGUNA</h3>
	<br/>
	<?php
		if(isset($_GET['msg'])){
			if($_GET['msg'] == "101"){
				...
				echo "Data Pengguna Berhasil Ditambahkan.</center>";
				echo "</div><br/>";
			}else{
	...
	<form method="POST" id="frm_add_pengguna" name="frm_add_pengguna" action="php/c_panel/cp_tambah_pengguna.php">
		...
		<table border="0px" cellspacing='0' cellpadding='6' width='100%'>
			<tr>
				<td>
					...
					<input type="text" name="id_skpd" id="id_skpd" onclick="show_skpd();" class="form-control" placeholder=":: PILIH UNIT KERJA /SKPD ::"/>
				</td>
			</tr>
		</table>
		<div class="kelang"></div>
