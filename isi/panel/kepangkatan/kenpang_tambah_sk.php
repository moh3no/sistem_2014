...
<form name="frm" id="frm" action="php/kpk/daftar_sk_tambah.php" method="post" target="sbm_target">
    ...
    <div class="bodypanel bodyfilter" id="bodyfilter">
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td width='50%'>
                    <label>NO. SK :</label>
                    <input type="text" name="no_sk" id="no_sk" class="form-control" placeholder=":: INPUT NO SK KENAIKAN PANGKAT ::"/>
                </td>
                <td>
                    <label>Tgl. SK :</label>
                    <input type="text" name="tgl_sk" id="tgl_sk" class="form-control" placeholder=":: INPUT TANGGAL SK KENAIKAN PANGKAT ::"/>
                </td>
            </tr>
            <tr>
                <td width='50%'>
