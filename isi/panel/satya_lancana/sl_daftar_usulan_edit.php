...
<?php
    require_once("php/model/usulan_satya_lancana_model.php");
...
<script type="text/javascript">
    ...
    function success(){
        jAlert("Data usulan satya lancana telah disimpan", "PERHATIAN", function(r){
            document.location.href="?mod=sl_daftar_usulan";
        });
    }
...
<form name="frm" id="frm" action="php/satya_lancana/sl_daftar_usulan_edit.php" method="post" target="sbm_target">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">EDIT SURAT USULAN SATYA LANCANA</h3>
