...
<form name="frm" id="frm" action="php/satya_lancana/sl_daftar_usulan_tambah.php" method="post" target="sbm_target">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">TAMBAH SURAT USULAN SATYA LANCANA</h3>
