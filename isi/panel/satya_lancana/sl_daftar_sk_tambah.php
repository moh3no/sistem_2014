...
<script type="text/javascript">
    ...
    function success(){
        jAlert("Data SK pengusulan satya lancana telah disimpan", "PERHATIAN", function(r){
            document.location.href="?mod=sl_daftar_sk";
        });
    }
...
<form name="frm" id="frm" action="php/satya_lancana/sl_daftar_sk_tambah.php" method="post" target="sbm_target">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">TAMBAH SK PENGUSULAN SATYA LANCANA</h3>
