...
<script type="text/javascript">
	...
	function terima(id_detail, id_usulan){
		jConfirm("Terima data usulan pegawai?", "PERHATIAN", function(r){
            if(r){
                document.location.href = "php/pi/acc_usulan_pi.php?id=" + id_detail + "&id_usulan=" + id_usulan;
            }
        });		
	}
	...
	function terima_surat(id_usulan){
		jConfirm("Terima data surat usulan pencantuman gelar ini ?", "PERHATIAN", function(r){
            if(r){
                document.location.href = "php/pi/terima_usulan_pi.php?id_usulan=" + id_usulan;
            }
        });	
	}
	...
	function tolak_surat(id_usulan){
		jConfirm("Tolak data surat usulan pencantuman gelar ini ?", "PERHATIAN", function(r){
            if(r){
                document.location.href = "php/pi/tolak_usulan_pi.php?id_usulan=" + id_usulan;
            }
        });	
	}
...
<?php
	...
	$sql = "SELECT * FROM tbl_usulan_pi WHERE id_usulan = '". $id_usul ."'";
...
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">SUPERVISI DATA USULAN PENYESUAIAN IJAZAH</h3>
	<?php
		if(isset($_GET['code']) && isset($_GET['name'])){
			...
			if($_GET['code'] == 1){	
				...
				echo "Anda Menerima Saudara/i <b>".$name."</b> ke dalam usulan Penyesuaian Ijazah</b>.</center>";
				echo "</div>";
			}else if($_GET['code'] == 2){
...
<div class="panelcontainer" style="width: 100%;">
    <h3 style="text-align: left;">SUPERVISI DAFTAR PEGAWAI USULAN PENYESUAIAN IJAZAH</h3>
    <div class="bodypanel">
...
<form name="frm_add_supervisi_pi" id="frm_add_supervisi_pi" action="php/pi/catatan_usulan_pi.php" method="POST">
<input type="hidden" id="id_textbox" />
<div class="panelcontainer" style="width: 100%;">
    <div class="bodypanel bodyfilter" id="bodyfilter">
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
				<input type="hidden" name="id_detail_pi" id="id_detail_pi" />
