...
<?php
    require_once("php/model/usulan_pi_model.php");
...
<script type="text/javascript">
    ...
    function success(){
        jAlert("Data usulan penyesuaian ijazah telah disimpan", "PERHATIAN", function(r){
            document.location.href="?mod=pi_daftar_usulan";
        });
    }
...
<form name="frm" id="frm" action="php/pi/pi_daftar_usulan_edit.php" method="post" target="sbm_target">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">EDIT SURAT USULAN PENYESUAIAN IJAZAH</h3>
