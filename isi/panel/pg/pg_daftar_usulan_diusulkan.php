    ...
    function hapus(id_detail){
        jConfirm("Anda yakin akan menghapus data ini?", "PERHATIAN", function(r){
            if(r){
                ...
                document.location.href="php/pg/pg_daftar_usulan_pop_diusulkan.php?id_usulan=" + id_usulan + "&id_detail=" + id_detail;
            }
        });
    }
	...
	<?php
		if(isset($_GET['code']) && isset($_GET['name'])){
			if($_GET['code'] == 1){	
				...
				echo "Anda Menambahkan Saudara <b>".$name."</b> ke dalam usulan Pencantuman Gelar</b>.</center>";
				echo "</div>";
			}else if($_GET['code'] == 2){
				...
				echo "Tambah pegawai usulan Pencantuman Gelar gagal.</center>";
				echo "</div>";
			}
		}	
	?>	
