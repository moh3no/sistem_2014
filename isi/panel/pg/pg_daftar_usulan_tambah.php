...
<script type="text/javascript">
    ...
    function success(){
        jAlert("Data surat usulan pencantuman gelar telah disimpan", "PERHATIAN", function(r){
            document.location.href="?mod=pg_daftar_usulan";
        });
    }
...
<form name="frm" id="frm" action="php/pg/pg_daftar_usulan_tambah.php" method="post" target="sbm_target">
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">TAMBAH SURAT USULAN PENCANTUMAN GELAR</h3>
