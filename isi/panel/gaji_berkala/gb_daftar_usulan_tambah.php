...
<form name="frm" id="frm" action="php/gaji_berkala/gb_daftar_usulan_tambah.php" method="post" target="sbm_target">
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td width='50%'>
                    ...
                    <input type="text" name="no_usulan" id="no_usulan" class="form-control" placeholder=":: INPUT NOMOR USULAN ::"/>
                </td>
                <td>
                    <label>Tgl. Surat Usulan :</label>
                    <input type="text" name="tgl_usulan" id="tgl_usulan" class="form-control" placeholder=":: INPUT TANGGAL SURAT USULAN ::"/>
                </td>
            </tr>
            <tr>
                <td width='50%'>
                    <label>Nama Pejabat Penandatangan :</label>
                    <input type="text" name="nama_ttd_usulan" id="nama_ttd_usulan" class="form-control" placeholder=":: INPUT NAMA PEJABAT PENANDATANGAN ::" />
                </td>
                <td>
                    <label>NIP Pejabat Penandatangan :</label>
                    <input type="text" name="nip_ttd_usulan" id="nip_ttd_usulan" class="form-control" placeholder=":: INPUT NIP PEJABAT PENANDATANGAN ::"/>
                </td>
            </tr>
            <tr>
                <td width='50%'>
                    <label>Jabatan Pejabat Penandatangan :</label>
                    <input type="text" name="jabatan_ttd_usulan" id="jabatan_ttd_usulan" class="form-control" placeholder=":: INPUT JABATAN PEJABAT PENANDATANGAN ::"/>
                </td>
                <td>
