        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td width='50%'>
                    ...
                    <input type="text" name="no_usul" id="no_usul" class="form-control" value="<?=$row['no_usulan'];?>" readonly="readonly"/>
                </td>
                <td>
                    <label>Tgl. Usulan:</label>
                    <input type="text" name="tgl_usul" id="tgl_usul" class="form-control" value="<?=$row['tgl_usulan'];?>" readonly="readonly"/>
                </td>
            </tr>
            <tr>
                <td width='50%'>
                    <label>Nama Pejabat Penandatangan  :</label>
                    <input type="text" name="pejabat_ttd" id="pejabat_ttd" class="form-control" value="<?=$row['nama_ttd_usulan'];?>" readonly="readonly"/>
                </td>
                <td>
                   <label>NIP Pejabat Penandatangan :</label>
				   <input type="text" name="nip_pejabat_ttd" id="nip_pejabat_ttd" class="form-control" value="<?=$row['nip_ttd_usulan'];?>" readonly="readonly"/>
                </td>
            </tr>
			...
			<tr>
				 <td width="50%">
                    ...
                    <input type="text" name="jabatan_ttd" id="jabatan_ttd" class="form-control" value="<?=$row['jabatan_ttd_usulan'];?>" readonly="readonly"/>
                </td>
			</tr>
