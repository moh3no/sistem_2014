<?php
    ...
    class UsulanPG_Model{
        ...
        public function Record($id_usulan){
            $sql = "SELECT * FROM tbl_usulan_pg WHERE id_usulan='" . $id_usulan . "'";
            $res = mysql_query($sql);
