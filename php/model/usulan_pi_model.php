<?php
    ...
    class UsulanPI_Model{
        ...
        public function Record($id_usulan){
            $sql = "SELECT * FROM tbl_usulan_pi WHERE id_usulan='" . $id_usulan . "'";
            $res = mysql_query($sql);
            while($ds = mysql_fetch_array($res)){
				...
				$this->catatan = $ds["catatan"];
            }
        }
        
        public function Insert(){
            $sql = "INSERT INTO tbl_usulan_pi(
                    	no_usulan,
                    	tgl_usulan,
                    	jabatan_ttd_usulan,
                    	nama_ttd_usulan,
